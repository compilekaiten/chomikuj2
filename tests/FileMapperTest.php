...
final class FileMapperTest extends TestCase {
    public function testCanBeCreated(): void {
        $this->assertInstanceOf(FileMapper::class, new FileMapper());
    }
    ...
    public function testMapSearchResponseReturnsObjectsWithValidData(): void {
        ...
        $this->assertEquals(DateTime::createFromFormat('Y-m-d H:i', '2013-05-03 22:54', new DateTimeZone('Europe/Warsaw')), $files[0]->getTimeUploaded());
        ...
        $this->assertEquals(DateTime::createFromFormat('Y-m-d H:i', '2017-08-14 05:58', new DateTimeZone('Europe/Warsaw')), $files[1]->getTimeUploaded());
    }
}
